...
- **iNavi Maps API:** Use the production base URL (`https://imaps.inavi.com`) for runtime API calls, but keep the documentation URL pointed at the development docs host (`https://dev-imaps.inavi.com/api-docs`). Generated docs and tooling expect this split.
